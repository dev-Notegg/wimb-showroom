...
import { dragAction, pinchAction, useGesture } from "@use-gesture/react";
  ...
  useGesture(
    {
      ...
      onPinch: ({
        ...
        console.log("offsets", s, "offseta", a);
        console.log("originox", ox, "originoy", oy);

        if (first) {
          const { width, height, x, y } = shapeRef.current?.getClientRect();
